...
**Current status:** Settings API foundation only. The plugin starts disabled. Settings → UTM Keeper lets administrators configure the future behavior, but there is no campaign capture, browser storage, reset, or link forwarding yet. Do not deploy it expecting attribution to work.
